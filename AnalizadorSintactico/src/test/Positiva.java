 ...
 * @author Charly
 */
public class Positiva extends javax.swing.JFrame {
    public AFN afn;
    /**
     * Creates new form Positiva
     */
    public Positiva() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Positiva.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
