 ...
 * @author Charly
 */
public class unirEstado extends javax.swing.JFrame {

    /**
     * Creates new form unirEstado
     */
    public unirEstado() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Escoja la opción de la unión especial ;)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(unirEstado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unirEstado().setVisible(true);
            }
        });
    }
