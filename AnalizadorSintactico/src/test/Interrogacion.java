 ...
 * @author Charly
 */
public class Interrogacion extends javax.swing.JFrame {
    public AFN afn;
    /**
     * Creates new form Interrogacion
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Interrogacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Interrogacion().setVisible(true);
            }
        });
    }
